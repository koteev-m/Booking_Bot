...
object RussianStrings : LocalizedStrings {
    ...
    override fun welcomeMessage(userName: String?) = userName?.let { "Рады Вас Видеть, @$it!\nВыберите действие:" } ?: "Рады Вас Видеть!\nВыберите действие:"
    ...
    override val tableLayoutInfo = "Ниже представлена схема расположения столов. Нажмите на кнопку с номером свободного стола."
    override fun tableButtonText(tableNumber: Int, seats: Int) = "Стол №$tableNumber (до $seats чел.)"
    override val noAvailableTables = "К сожалению, в выбранном клубе сейчас нет доступных столов для онлайн-бронирования на выбранную дату."
    override val askPeopleCount = "Сколько гостей придёт? (например, <b>5</b>)"
    override fun invalidPeopleCount(min: Int, max: Int) = "Количество гостей должно быть числом от $min до $max. Пожалуйста, введите корректное число."
    override val chooseSlotPrompt = "Выберите удобный временной слот:"
    override fun chooseSlotForTableInClub(tableNumber: Int, clubName: String) = "Выберите время для стола №$tableNumber в клубе \"$clubName\":"
    override val noAvailableSlots = "К сожалению, для выбранного стола нет доступных слотов на эту дату."
    override val confirmBookingPrompt = "Пожалуйста, подтвердите вашу бронь:"
    override fun bookingDetailsFormat(clubName: String, tableNumber: Int, guestCount: Int, date: String, timeSlot: String, guestName: String, guestPhone: String) =
        """
        <b>Клуб:</b> $clubName
    ...
    override val invalidPhoneFormat = "Неверный формат номера телефона. Пожалуйста, введите номер в формате +7XXXXXXXXXX или 8XXXXXXXXXX."
    override fun bookingSuccess(bookingId: Int, points: Int) = "✅ Бронь #$bookingId успешно создана! Вам начислено $points бонусных баллов. Спасибо!"
    ...
    override fun bookingCancellationConfirmed(bookingId: Int, clubName: String) = "Ваша бронь #$bookingId в клубе '$clubName' отменена."
    ...
    override fun venueDetails(clubTitle: String, clubDescription: String?, address: String?, phone: String?, workingHours: String?) =
        """
        <b>$clubTitle</b>
    ...
    override fun bookingItemFormat(bookingId: Int, clubName: String, tableNumber: Int, date: String, time: String, guestsCount: Int, status: String) =
    ...
    override fun manageBookingPrompt(bookingId: Int, details: String) = "<b>Бронь #$bookingId:</b>\n$details\n\nЧто вы хотите сделать?"
    ...
    override val changeBookingInfo = "Для изменения бронирования, пожалуйста, отмените текущее и создайте новое, или свяжитесь с администрацией клуба."
    ...
    override fun askForFeedbackPrompt(clubName: String, bookingId: Int) = "Пожалуйста, оцените ваше недавнее посещение клуба $clubName (бронь #$bookingId). Выберите оценку от 1 до 5 (⭐️):"
...
object EnglishStrings : LocalizedStrings {
    ...
    override fun welcomeMessage(userName: String?) = userName?.let { "Welcome, @$it!\nPlease select an action:" } ?: "Welcome!\nPlease select an action:"
    ...
    override val errorMessageDefault = "⚠️ An error occurred. Please try again or start over with the /start command."
    override val unknownCommand = "I didn't quite understand that. Please use the menu buttons or the /start command."
    override val featureInDevelopment = "🛠 This feature is currently under development. Stay tuned for updates!"
    ...
    override val tableLayoutInfo = "Below is the table layout. Click on the button with the number of an available table."
    override fun tableButtonText(tableNumber: Int, seats: Int) = "Table #$tableNumber (up to $seats ppl)"
    override val noAvailableTables = "Unfortunately, there are no tables available for online booking at the selected club for the chosen date."
    override val askPeopleCount = "How many guests will there be? (e.g., <b>5</b>)"
    override fun invalidPeopleCount(min: Int, max: Int) = "The number of guests must be between $min and $max. Please enter a correct number."
    override val chooseSlotPrompt = "Select a convenient time slot:"
    override fun chooseSlotForTableInClub(tableNumber: Int, clubName: String) = "Select a time for table #$tableNumber at \"$clubName\":"
    override val noAvailableSlots = "Unfortunately, there are no available slots for the selected table on this date."
    ...
    override val invalidGuestName = "Name cannot be empty or too short. Please enter a correct name."
    override val askGuestPhone = "Please enter your contact phone number (e.g., <b>+12345678900</b>):"
    override val askGuestPhoneExample = "(e.g., +12345678900)"
    override val invalidPhoneFormat = "Invalid phone number format. Please enter a valid number."
    override fun bookingSuccess(bookingId: Int, points: Int) = "✅ Booking #$bookingId successfully created! You've earned $points loyalty points. Thank you!"
    ...
    override val bookingNotFound = "Booking not found or you do not have permission for this action."
    override fun bookingCancellationConfirmed(bookingId: Int, clubName: String) = "Your booking #$bookingId at '$clubName' has been cancelled."
    override val notAllDataCollectedError = "Not all booking data was collected. Please start over."
    ...
    override fun manageBookingPrompt(bookingId: Int, details: String) = "<b>Booking #$bookingId:</b>\n$details\n\nWhat would you like to do?"
    ...
    override val changeBookingInfo = "To change your booking, please cancel the current one and create a new one, or contact the club administration."

    override val askQuestionPrompt = "Write your question, and we will try to answer as soon as possible:"
    override val questionReceived = "Thank you! Your question has been received. We will contact you soon."
    ...
    override val helpText = """
        ...
        """.trimIndent()
    override fun askForFeedbackPrompt(clubName: String, bookingId: Int) = "Please rate your recent visit to $clubName (booking #$bookingId). Choose a rating from 1 to 5 (⭐️):"
    override fun feedbackThanks(rating: Int) = "Thank you for your feedback ($rating ⭐)! We appreciate your opinion."
...
object StringProviderFactory {
    ...
    fun get(languageCode: String?): LocalizedStrings {
        return providers[languageCode?.lowercase()] ?: providers[BotConstants.DEFAULT_LANGUAGE_CODE]!!
    }
